...
def generate_design_matrix(filenames, vectorizer=None):
    ...
    return design_matrix.todense(), vectorizer
...
all_design_matrix, vectorizer = generate_design_matrix(all_filenames)
...
scipy.io.savemat(BASE_DIR + 'spam_data.mat', file_dict)
